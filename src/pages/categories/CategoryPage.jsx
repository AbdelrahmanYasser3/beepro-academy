...
const CategoryPage = ({
  ...
  return (
    <div className="category-page">
          ...
          <div className="category-hero-content">
            ...
            <div className="category-hero-features">
              {features.map((feature, idx) => (
                <span key={idx} className="category-hero-tag">
                  {feature}
                </span>
              ))}
            </div>
      ...
      <section
        className="category-courses-section"
        style={{ "--courses-bg-image": `url(${backgroundImage})` }}
      >
          ...
          <div className="category-courses-grid">
            {displayCourses.length > 0 ? (
              displayCourses.map((course) => (
                <div
                  key={course.id}
                  className="category-course-card"
                  style={{ "--card-color": color }}
                >
                  <div
                    className="category-course-image"
                    style={{
                      backgroundImage: `url(${course.image || backgroundImage})`,
                    }}
                  >
                    <span className="category-course-level">
                      {course.level}
                    </span>
                  </div>
                  <div className="category-course-content">
                    ...
                    <div className="category-course-meta">
                      ...
                      <span className="category-course-price">
                        {formatDisplayPrice(course.price)}
                      </span>
                    </div>
                    <Link
                      to={`/courses/${course.id}`}
                      className="category-course-btn"
                    >
                      View Course
                    </Link>
                  </div>
              ...
              <div className="category-courses-empty">
                ...
                <Link to="/courses" className="category-course-btn">
                  Browse All Courses
                </Link>
              </div>
            )}
      ...
      {/* CTA Section */}
      <section
        className="category-cta-section"
      ...
      >
        <div className="category-cta-content">
          ...
          <div className="category-cta-buttons">
            <Link to="/register" className="category-cta-btn primary">
              Get Started Today
            </Link>
            <Link to="/contact" className="category-cta-btn secondary">
              Contact Us
            </Link>
          </div>
        </div>
